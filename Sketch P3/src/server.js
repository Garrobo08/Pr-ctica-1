// Definiendo un Map para almacenar deportes y un contador de ID
const sports = new Map();
let nextId = 0;
//ELEMENTOS
// Función para agregar un deporte al Mapa
export function addSport(sport) {
    let id = nextId++;
    sport.id = id.toString();
    sports.set(sport.id, sport);   //La clave de este sport es la sport.id
}
// Función para obtener un deporte por su ID
...
// }
// Función para obtener deportes en un rango específico
export function getSports(from, to) {
    let values = [...sports.values()];
    if (from !== undefined) {
...
export function loadSampleData() {
    ...
    //List obtained from https://comicvine.gamespot.com/profile/wrestlgurl/lists/top-25-sports/43101/
